...
- Generate a **Custom** `.cursor/context.md` with the findings.
...
- If the stack is **totally unknown** (e.g., Perl), generate a generic `.cursor/rules/style.mdc` based on the observed patterns.
