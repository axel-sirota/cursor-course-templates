...
- Development tooling configured (eslint, prettier, tsc, jest)
...
**Deliverables:**
- Prisma migration for [table]
- Zod schemas ([Entity]Base, [Entity], [Entity]Create, [Entity]Update)
- [Entity]Repository with typed mappers
...
- [Entity] schemas (represent core entity)
...
**Deliverables:**
- [List if new Prisma models needed, otherwise "Uses existing models"]
...
- Foreign key relationships need parent models to exist first
...
- [ ] Linting passing (`npx eslint src/ tests/`)
...
- [ ] All phases complete
- [ ] Full test suite passing (`npx jest`)
...
### Database Rollback
Each Prisma migration should be reversible:
- Keep migration history in `prisma/migrations/`
- Test `npx prisma migrate reset` in a scratch environment
