...
- Step Where Problem Occurred: [Test/Migration/Implementation/etc.]
...
- JDK version: [21.x.x / Temurin build]
- Spring Boot version: [x.x.x]
- Maven version: [x.x.x, via `./mvnw -v`]
...
### Primary Error
```
[Full Java stack trace, including "Caused by:" chains]
```
...
### Log Output
```
[Relevant Spring Boot log entries showing the problem]
```
...
2. [Spring Boot / JPA / Hibernate behavior question]
...
- [Spring Boot docs link] - [What was checked]
- [Spring Data JPA docs link] - [What was checked]
- [Flyway docs link] - [What was checked]
- [Hibernate docs link] - [What was checked]
...
**File:** [path/to/WorkingExample.java]
```java
